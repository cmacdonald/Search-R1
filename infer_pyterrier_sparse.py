...
search_pipeline = pt.rewrite.tokenise() >> sparse_index.bm25(include_fields=['docno', 'text', 'title'], threads=5, num_results=3) >> pt.rewrite.reset()
...
def search(query: str):
    res = search_pipeline.search(query)
